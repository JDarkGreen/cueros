<?php /*Template Name: Página Galería - Plantilla */ ?>
<?php  
...
/*
 * Obtener Primera Galería
 */
if( $galleries ) :
	$the_gallery = $galleries[0];
endif;
		...
		<div class="row">
			...
			<div class="col-xs-12 col-sm-8">
				...
				<div class="containerSectionGallery">
					...
					<?php if(isset($the_gallery)) : ?>
						
						<!-- Título -->
						<h2 class="title-gallery text-uppercase">
							<strong>
								<?= __(  $the_gallery->post_title , LANG ); ?>
							</strong>
						</h2>

						<!-- Texto -->
						<?= apply_filters( 'the_content' , $the_gallery->post_content ); ?>
						...
						<?php  
							 ...
							 */
							$mb_gallery_images = get_gallery_post($the_gallery->ID);
