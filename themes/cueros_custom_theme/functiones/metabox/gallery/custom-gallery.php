...
?>
    ...
    <section class="js-containerParentGallery">
        ...
        <section class="js-containerSortableGallery" data-field-id="field_customize_gallery" style="">
            ...
            ?>
                ...
                <figure class='ui-state-default' data-id-element="<?= $item->ID ?>" style="width: 202px; height: 120px; margin: 0 10px 20px; display: inline-block; vertical-align: top; position: relative; float:left; border: 1px dotted;">
        ...
        </section> <!--/.js-containerSortableGallery -->
